...
if(isset($_GET['data'])){
  ...
  $sql_z = "SELECT `judul`,`isi` FROM `berita` WHERE `id_berita`='$id_berita'";
  //echo $sql;
...
?>
    ...
    <div class="card card-info">
      ...
      <form class="form-horizontal" method="post" action="index.php?include=konfirmasi-edit-berita">
        <div class="card-body">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-7">
              <select class="form-control" id="kategori" name="kategori">
                <?php 
                  $sql = "SELECT `id_kategori_berita`,`kategori_berita` FROM `kategori_berita` ORDER BY `kategori_berita`";
                  //echo $sql;
